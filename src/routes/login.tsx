    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="w-full max-w-md rounded-xl border border-border bg-card p-8 shadow-sm">
        ...
        <p className="mt-1 text-center text-sm text-muted-foreground">
          Sign in to track your Yale degree.
        </p>
        ...
        <YaleNetIdButton className="mt-3 w-full" label="Sign in with Yale NetID (CourseTable)" />

        <p className="mt-2 text-center text-xs text-muted-foreground">
          Yale NetID connects CourseTable for the full course catalog. You still need a BluePath account to save your progress.
        </p>
