    ...
    requirements: {
      BA: {
        ...
        prerequisites: [
          {
            id: "math",
            label: "Calculus (MATH 112+)",
            codes: ["MATH 112", "MATH 115", "MATH 120"],
            needCount: 1,
          },
        ],
        core: [
          ...
          {
            id: "tools",
            label: "Discrete math: CPSC 202 or MATH 244",
            codes: ["CPSC 202", "MATH 244"],
            needCount: 1,
          },
          ...
          {
            id: "algo",
            label: "Algorithms: CPSC 365 or 366",
            codes: ["CPSC 365", "CPSC 366"],
            needCount: 1,
          },
          {
            id: "cs_electives",
      ...
      BS: {
        ...
        prerequisites: [
          {
            id: "calc",
            label: "Calculus (MATH 115 or 120)",
            codes: ["MATH 115", "MATH 120"],
            needCount: 1,
          },
          {
            id: "lin",
            label: "Linear algebra (MATH 222/225/230)",
            codes: ["MATH 222", "MATH 225", "MATH 230"],
            needCount: 1,
          },
        ],
        core: [
          ...
          },
          {
            ...
            codes: ["S&DS 241", "S&DS 220", "S&DS 230"],
            needCount: 1,
          },
        ],
        senior: [
    ...
    requirements: {
      BA: {
        ...
        prerequisites: [
          ...
          {
            id: "calc",
            label: "Math (MATH 1180/1200 preferred, or 1120+)",
            codes: ["MATH 112", "MATH 115", "MATH 118", "MATH 120"],
            needCount: 1,
          },
        ],
        core: [
          {
            ...
            codes: ["ECON 121", "ECON 2121", "ECON 2125"],
            needCount: 1,
          },
          {
            id: "macro",
            label: "Intermediate macro (ECON 2122 or 2126)",
            codes: ["ECON 122", "ECON 2122", "ECON 2126"],
            needCount: 1,
          },
          {
            id: "metrics",
    ...
    requirements: {
      BA: {
        ...
        core: [
          {
            id: "intro",
            label: "2 introductory PLSC courses",
            codePrefix: ["PLSC"],
            maxLevel: 1999,
            needCount: 2,
          },
          {
            id: "lectures",
            label: "2 non-intro core lecture courses",
            codePrefix: ["PLSC"],
            minLevel: 200,
            needCount: 2,
          },
          ...
          {
            id: "subfields",
            label: "2 courses each in 2 of 4 subfields",
            codePrefix: ["PLSC"],
            needCount: 4,
          },
          {
            id: "seminars",
            label: "2 departmental seminars (1 in senior year)",
            codePrefix: ["PLSC"],
            minLevel: 300,
            needCount: 2,
          },
        ...
        senior: [
          {
            id: "senior",
            label: "Senior essay (seminar or PLSC 4900)",
            codePrefix: ["PLSC"],
            minLevel: 490,
            needCount: 1,
          },
        ...
        requirements: {
          BA: {
            ...
            core: [
              ...
              {
                id: "concentration",
                label: "7 courses relating to chosen concentration",
                codePrefix: ["PLSC"],
                needCount: 7,
              },
              {
            ...
            senior: [
              {
                id: "senior",
                label: "PLSC 4900 junior year + senior essay",
                codePrefix: ["PLSC"],
                minLevel: 490,
                needCount: 1,
              },
        ...
        requirements: {
          BA: {
            ...
            core: [
              ...
              {
                id: "outside",
                label: "3 courses from other departments (DUS approval)",
                codePrefix: ["ECON", "HIST", "PHIL", "SOCY", "GLBL", "ANTH"],
                needCount: 3,
              },
              {
                id: "seminars",
                label: "2 departmental seminars",
                codePrefix: ["PLSC"],
                minLevel: 300,
                needCount: 2,
              },
            ...
            senior: [
              {
                id: "senior",
                label: "Two-term essay (PLSC 4901/4903)",
                codePrefix: ["PLSC"],
                minLevel: 490,
                needCount: 2,
              },
        ...
        requirements: {
          BA: {
            ...
            core: [
              ...
              {
                id: "cw",
                label: "4 creative writing courses (2 advanced 4000+)",
                codePrefix: ["ENGL"],
                minLevel: 400,
                needCount: 4,
              },
              {
                id: "literature",
                label: "At least 11 literature courses total",
                codePrefix: ["ENGL"],
                needCount: 7,
              },
            ],
            senior: [
              {
                id: "senior_sem",
                label: "2 senior seminars or ENGL 4100/4101",
                codePrefix: ["ENGL"],
                minLevel: 400,
                needCount: 2,
              },
              {
                id: "cw_project",
                label: "Creative writing senior project (ENGL 4400)",
                codes: ["ENGL 4400"],
                needCount: 1,
              },
            ],
    ...
    requirements: {
      BA: {
        ...
        prerequisites: [
          {
            id: "calc",
            label: "Introductory sequence (MATH 1150/1200, 2250/2260, 2550/2560, 3020/1200)",
            codes: [
              "MATH 115",
              "MATH 120",
              "MATH 225",
        ...
        core: [
          ...
          {
            id: "algebra",
            label: "Abstract Algebra (MATH 3500)",
            codes: ["MATH 350"],
            needCount: 1,
          },
          {
        ...
        senior: [
          {
            id: "senior",
            label: "Senior seminar (MATH 4800–4890) or essay (MATH 4750)",
            codePrefix: ["MATH"],
            minLevel: 475,
            needCount: 1,
          },
        ...
        prerequisites: [
          {
            ...
            codes: ["MATH 115", "MATH 120", "MATH 225", "MATH 226", "MATH 255", "MATH 256"],
            needCount: 4,
          },
        ],
        core: [
          {
            id: "linalg",
            label: "Linear Algebra (MATH 225/230)",
            codes: ["MATH 225", "MATH 230"],
            needCount: 1,
          },
          { id: "analysis", label: "Real Analysis (MATH 3050)", codes: ["MATH 305"], needCount: 1 },
          {
          ...
          {
            id: "outside",
            label: "2 advanced courses in physical science",
            codePrefix: ["PHYS", "CPSC", "CHEM"],
            minLevel: 200,
            needCount: 2,
          },
        ],
    ...
    requirements: {
      BS: {
        ...
        prerequisites: [
          {
            id: "math",
            label: "Calculus through MATH 120",
            codes: ["MATH 115", "MATH 120"],
            needCount: 2,
          },
          {
            id: "phys",
            label: "University Physics I & II",
            codes: ["PHYS 180", "PHYS 181", "PHYS 200", "PHYS 201"],
            needCount: 2,
          },
        ],
        core: [
          ...
          {
            id: "pchem",
            label: "Physical Chemistry (CHEM 332)",
            codes: ["CHEM 332"],
            needCount: 1,
          },
          {
            id: "labs",
            label: "Lab work (CHEM 174/175/222)",
            codes: ["CHEM 174", "CHEM 175", "CHEM 222"],
            needCount: 2,
          },
          {
            id: "chem_electives",
    ...
    requirements: {
      BA: {
        ...
        core: [
          {
            id: "preindustrial",
            label: "2 course credits in preindustrial history",
            codePrefix: ["HIST"],
            needCount: 2,
          },
          {
            id: "seminars",
            label: "2 departmental seminars (3000-level)",
            codePrefix: ["HIST"],
            minLevel: 300,
            needCount: 2,
          },
        ...
        senior: [
          {
            id: "senior",
            label: "Senior essay (HIST 4995–4997)",
            codePrefix: ["HIST"],
            minLevel: 490,
            needCount: 1,
          },
    ...
    requirements: {
      BA: {
        ...
        prerequisites: [
          ...
          {
            id: "stats",
            label: "Statistics (S&DS 1000 or 2300)",
            codes: ["S&DS 100", "S&DS 230"],
            needCount: 1,
          },
        ],
        core: [
      ...
      BS: {
        ...
        prerequisites: [
          ...
          {
            id: "stats",
            label: "Statistics (PSYC 200 or S&DS)",
            codes: ["PSYC 200", "S&DS 100"],
            needCount: 1,
          },
        ],
        core: [
          {
            id: "social",
            label: "2 social science courses in Psychology",
            codePrefix: ["PSYC"],
            needCount: 2,
          },
          {
            id: "natural",
            label: "2 natural science courses in Psychology",
            codePrefix: ["PSYC"],
            needCount: 2,
          },
          {
            id: "methods",
            label: "Data-collection/research methods course",
            codePrefix: ["PSYC"],
            minLevel: 200,
            needCount: 1,
          },
          {
            id: "advanced_sci",
            label: "2 advanced science courses",
            codePrefix: ["PSYC", "BIOL", "MCDB", "NSCI"],
            minLevel: 200,
            needCount: 2,
          },
        ...
        senior: [
          {
            id: "senior",
            label: "Senior research (PSYC 499)",
            codePrefix: ["PSYC"],
            minLevel: 490,
            needCount: 1,
          },
