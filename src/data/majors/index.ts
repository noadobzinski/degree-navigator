...
export const MAJORS_BY_ID: Record<string, Major> = Object.fromEntries(MAJORS.map((m) => [m.id, m]));

export const MAJOR_DEPARTMENTS: string[] = [...new Set(MAJORS.map((m) => m.department))].sort();
